...
void game() {
	...
	} while (!gameover && counter < wordnum); //termination condition - if accuracy falls below 70% or user finish all set of words

	system("clear");
	if (gameover) { //if-else statement determinining game over by accuracy or stage clear finishing whole set of words
		cout << "Game Over" << endl;
